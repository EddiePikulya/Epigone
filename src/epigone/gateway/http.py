...
from epigone.gateway import GatewayError, LeaderboardEntry, PortfolioWindow, Position, Window
...
class HttpHyperliquidGateway:
    ...
    async def get_open_positions(self, address: str) -> list[Position]:
        raise NotImplementedError("arrives with the stream poller (issue #4)")
